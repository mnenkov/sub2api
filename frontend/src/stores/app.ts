...
import { PUBLIC_BRAND_NAME, resolvePublicSiteName } from '@/utils/publicBrand'
...
export const useAppStore = defineStore('app', () => {
  ...
  const siteName = ref<string>(PUBLIC_BRAND_NAME)
  ...
  function applySettings(config: PublicSettings): void {
    ...
    siteName.value = resolvePublicSiteName(config.site_name)
