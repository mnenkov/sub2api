...
const (
	...
	AdminComplianceAckPhraseZH    = ""
	AdminComplianceAckPhraseEN    = "I have read, understood, and agree to the AI API Gateway Deployment and Operation Compliance Commitment"
